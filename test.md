...
4. Змінні та типи даних.
    1. Відео
    2. Поговоримо про те, на які види поділяють інформацію у Python та як зберегти щось у памʼятті.
5. Авточек 2
6. Авточек 3
7. Форматування рядка, спеціальні символи.
    1. Відео
    2. Розберемо детальніше роботу з рядками, зокрема як динамічно формувати повідомлення.
8. Авточек 4
9. Авточек 5
...
13. Умовне виконання
    1. Відео
    2. У цьому відео поговоримо про те, як у програмуванні працює механізм умовного виконання та як одна і таж програма може видавати різні результати.
14. Авточек 8
15. Авточек 9
16. Методи рядка
    1. Відео
...
19. Індексація
    1. Відео
    2. Розглянемо роботу з вкладеним (двовимірним) списком та індексацію, зокрема механізм зрізів.
20. Авточек 12
21. Авточек 13
22. Цикл for
    1. Відео
...
27. Обробка винятків
    1. Відео
    2. У цьому відео поговоримо про ситуації, коли програма може зупинити виконання достроково. Розглянемо винятки та способи їх обробки.
28. Авточек 17
29. Авточек 18
30. Функції
    1. Відео
    2. Поговоримо про те, чому важливо розбивати код на функції та які переваги це надає.
31. Авточек 19
32. Авточек 20
33. Збираємо проект
    1. Відео
